...
class CarritoCompras:
    def __init__(self, id_carrito_compras, id_usuario, fecha_creacion):
        self.id_carrito_compras = id_carrito_compras
...
class Pedido:
    def __init__(self, id_pedido, id_usuario, fecha_pedido):
...
class Producto:
    def __init__(self, id_producto, nombre_producto, descripcion_producto, precio_producto, categoria_producto, url_img_prod, stock_producto):
        self.id_producto = id_producto
        self.nombre_producto = nombre_producto
        self.descripcion_producto = descripcion_producto
        self.precio_producto = precio_producto
        self.categoria_producto = categoria_producto
        self.url_img_prod = url_img_prod
        self.stock_producto = stock_producto



class Usuario:
    def __init__(self, id_usuario, nombre, apellido, correo_electronico, contrasena):
        self.id_usuario = id_usuario
        self.nombre = nombre
...
def escolar():
    ...
    return jsonify({"data":productos,"categorias":categories})
